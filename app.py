...
if __name__ == '__main__':
    ...
    if os.environ.get('ENV', 'development') == 'init':
        ...
        ##########서버에 secret피일 이미 있음 #################
        ACCESS_KEY_ID = 'AKIAV2TBPZARBJUMT47L'  # os.environ.get('ACCESS_KEY_ID')
        ACCESS_SECRET_KEY = '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'  # os.environ.get('ACCESS_SECRET_KEY')
        BUCKET_NAME = 'ccl-fl-demo-model'  # os.environ.get('BUCKET_NAME')
